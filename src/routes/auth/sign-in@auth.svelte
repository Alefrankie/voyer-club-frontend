...
<svelte:head>
	<title>VoyerClub - Iniciar Sesión</title>
</svelte:head>
		...
		<div class="signin-signup">
			<form on:submit|preventDefault={signIn}>
				...
				<div class="input-field">
					<i class="fas fa-user" />
					<input placeholder="Usuario" required bind:value={currentUser.username} />
				</div>
				<div class="input-field">
					<i class="fas fa-lock" />
					<input
				...
				<a href="/auth/forget-password" style="color: #585858">Restaurar contraseña</a>
